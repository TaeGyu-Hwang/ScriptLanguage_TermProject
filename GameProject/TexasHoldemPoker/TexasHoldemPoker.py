...
class TexasHoldemPoker:
    ...
    def setupLabel(self):
        ...
        self.Lstatus = Label(text="", width=10, height=1, font=self.fontstyle, bg="green", fg="white")
        self.Lstatus.place(x=575, y=240)
        self.LplayerRank = Label(text="", width=12, height=1, font=self.fontstyle, bg="green", fg="cyan")
        self.LplayerRank.place(x=300, y=380)
        self.LdealerRank = Label(text="", width=12, height=1, font=self.fontstyle, bg="green", fg="cyan")
    ...
    def checkUserCard(self, user):
        ...
        _cards.sort(key=lambda card: card.value)
